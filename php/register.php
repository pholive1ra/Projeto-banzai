<?php
    ...
    if (isset($_POST['submit']))
    {
        ...
        {
            $result = mysqli_query($conexao, "INSERT INTO usuarios(nome, email, senha, telefone, data_nasc, genero, nome_mae, cep, cpf) 
            VALUES ('$nome', '$email', '$senha', '$telefone', '$nascimento', '$genero', '$nomeMaterno', '$cep', '$cpf')");
